...
Lexer.prototype = {
  ...
  getIdentifierName() {
    ...
    if (match) {
      ...
      const type = keywords.hasOwnProperty(value) ? Token.Keyword : Token.Identifier;
...
Object.keys(Token).reduce((proto, tokenName) => {
  proto[`get${tokenName}`] = createTokenGetter(Regex[tokenName], Token[tokenName]);
