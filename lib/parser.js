...
Parser.prototype = {
    ...
    if (
      ...
      switch (value) {
        case 'this':
          ...
          break;
        case 'function':
          return this.error(UnsupportedFunction, token);
        case 'class':
          return this.error(UnsupportedClass, token);
        case 'yield':
        ...
        case 'let':
          ...
          break;
        case 'super':
          return this.error(UnsupportedSuper, token);
        default:
  ...
  parse() {
    ...
    if (begin === null) {
      return new Program([]);
    } else if (this.lexer.stash.length === 1 && isSimplePrimary(begin)) {
